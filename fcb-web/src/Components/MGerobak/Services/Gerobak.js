export const getMasterGerobak = () => {
    return fetch('http://192.168.1.52:3030/api/master/gerobak', {
        method: 'GET',
        headers: {
...
export const getMasterGerobakDetail = (value) => {
    return fetch('http://192.168.1.52:3030/api/master/detail-gerobak', {
        method: 'POST',
        body: JSON.stringify({
            id: value
        }),
...
export const simpanDataGerobak = (dataSimpan) => {
    if (dataSimpan.id && (dataSimpan.id !== null || dataSimpan.id !== "")) {
        return fetch("http://192.168.1.52:3030/api/master/edit-gerobak", {
            method: 'POST',
            body: JSON.stringify({
                id: dataSimpan.id,
        ...
        return fetch("http://192.168.1.52:3030/api/master/tambah-gerobak", {
            method: 'POST',
            body: JSON.stringify({
                id: dataSimpan.id,
                code: dataSimpan.code,
...
export const setDeleteGerobak = (idGerobak) => {
    return fetch("http://192.168.1.52:3030/api/master/delete-gerobak", {
        method: 'POST',
        body: JSON.stringify({
            id: idGerobak
        }),
